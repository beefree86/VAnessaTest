...
зафиксировать заказанный поствщику товар
...
//Сценарий: варианты сравнения данных, сортировки, сравнение с макетом
//	И я закрываю все окна клиентского приложения
//	Дано Я открываю навигационную ссылку "e1cib/list/Document.PurchaseOrder"
//	И я нажимаю на кнопку с именем 'FormCreate'
//	И я нажимаю кнопку выбора у поля с именем "Partner"
...
//		| '125,00'            | ''             | '1' | 'Товар без характеристик' | 'Нет'                    | 'Товар без характеристик' | '25,00'         | ''                   | '1,000'      | 'Заказ поставщику 1 от 15.03.2022 16:03:11' | 'шт'       | '20%' | ''                 | '150,00'      | ''                | 'Склад 1 (с контролем остатка)' | 'Цена поставщика 1' | ''                | ''                      | '150,00' | ''                         | ''                             | 'Да'                                        | ''            |
//		| '250,00'            | ''             | '2' | 'Товар без характеристик' | 'Нет'                    | 'Товар без характеристик' | '50,00'         | ''                   | '2,000'      | 'Заказ поставщику 1 от 15.03.2022 16:03:11' | 'шт'       | '20%' | ''                 | '300,00'      | ''                | 'Склад 1 (с контролем остатка)' | 'Цена поставщика 1' | ''                | ''                      | '150,00' | ''                         | ''                             | 'Да'                                        | ''            |
